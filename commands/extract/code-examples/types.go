...
type CodeExample struct {
	...
	DirectiveName rst.DirectiveType // Type of directive (code-block, code, literalinclude, io-code-block)
...
type Report struct {
	...
	DirectiveCounts    map[rst.DirectiveType]int    // Count of examples by directive type
...
type SourceStats struct {
	DirectiveCounts map[rst.DirectiveType]int // Count of directives by type in this file
